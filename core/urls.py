...
urlpatterns = [
    ...
    path('question/<str:keyword>/<int:question_number>/<str:question_text>/', views.question_view, name='question'),
    path('answer/<str:keyword>/<int:question_number>/<str:question_text>/', views.answer_question, name='answer_question'),
    ...
    path('explanation/<str:keyword>/<int:question_number>/<str:question_text>/', views.explanation_view, name='explanation'),
